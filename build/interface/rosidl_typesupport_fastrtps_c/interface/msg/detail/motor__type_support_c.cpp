...
#include "interface/msg/detail/motor__rosidl_typesupport_fastrtps_c.h"
...
using _Motor__ros_msg_type = interface__msg__Motor;
...
size_t get_serialized_size_interface__msg__Motor(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name mag
  {
    size_t item_size = sizeof(ros_message->mag);
...
static uint32_t _Motor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface__msg__Motor(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface
size_t max_serialized_size_interface__msg__Motor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface__msg__Motor;
    is_plain =
      (
...
static size_t _Motor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface__msg__Motor(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface, msg, Motor)() {
