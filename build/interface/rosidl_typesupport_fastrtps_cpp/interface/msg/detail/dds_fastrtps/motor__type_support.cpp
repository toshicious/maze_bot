...
#include "interface/msg/detail/motor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface::msg::Motor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::msg::Motor & ros_message)
{
  // Member: mag
  cdr >> ros_message.mag;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface::msg::Motor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface::msg::Motor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface::msg::Motor *>(
    untyped_ros_message);
...
{
  return &interface::msg::typesupport_fastrtps_cpp::_Motor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, msg, Motor)() {
  return &interface::msg::typesupport_fastrtps_cpp::_Motor__handle;
}
